...
\begin{equation}
  \underline{U}_{\symup{G}}(t)=U_{\symup{0}}\exp(i\omega t) \,.
\end{equation}
...
gegen unendlich. Die dafür charakteristische Kreisfrequenz lässt sich zu
\begin{equation}
...
am Kondensator geht dann gegen null.
...
null und für große Frequenzen gegen $\pi$ geht, wobei $U_{\symup{G}}$ $U_{\symup{C}}$
...
ist $\omega_{\symup{1}}$ der Wert, bei dem die Phasenverschiebung $\phi=\frac{\pi}{4}$ beträgt
und $\omega_{\symup{2}}$ der Wert, bei dem die Phasenverschiebung $\phi=\frac{3\pi}{4}$ beträgt.
