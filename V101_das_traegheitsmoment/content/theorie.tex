...
\end{equation}
wobei $I$ das gesamte Trägheitsmoment darstellt. Wird das gesamte Trägheitsmoment
$I$ nun in die einzelnen Trägheitsmomente $I_{\symup{D}}$ der Drillachse und
$I_{\symup{K}}$ des Körpers aufgeteilt und nach $I_{\symup{K}}$ umgestellt, so ergibt sich für
...
Für die im Versuch verwendeten Körper ergeben sich aus \eqref{eqn:traegheitallg}
...
\begin{gather}
  ...
  \begin{split}
    ...
    +2\Bigl(I_{\symup{A}}+m_{\symup{A}}(R_{\symup{R}}+R_{\symup{A}})^2\Bigr)
    +2\Biggl(I_{\symup{B}}+m_{\symup{B}}\biggl(\frac{h_{\symup{B}}}{2}\biggr)^2\Biggr)
    \label{eqn:traegheitpuppe1}
  \end{split}
  \\
  \begin{split}
    I_{\symup{Puppe2}}=I_{\symup{K}}+I_{\symup{R}}
    +2\Biggl(I_{\symup{A}}+m_{\symup{A}}\biggl(R_{\symup{R}}+\frac{h_{\symup{A}}}{2}\biggr)^2\Biggr)
    +2\Biggl(I_{\symup{B}}+m_{\symup{B}}\biggl(\frac{h_{\symup{B}}}{2}\biggr)^2\Biggr)
...
Radien, $h_{\symup{A}}$ und $h_{\symup{B}}$ die zugehörigen Höhen und $m_{\symup{A}}$ und $m_{\symup{B}}$
die zugehörigen Massen. Die quadrierten Summanden
