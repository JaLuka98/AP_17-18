...
plt.legend()
plt.xlabel('$(Lx^3-x^3/3)$/mm')
plt.ylabel('$D(x)$/mm')
plt.savefig('rundeinseitig.pdf')
...
plt.xlabel('$(Lx^3-x^3/3)$/mm')
plt.ylabel('$D(x)$/mm')
plt.savefig('quadratischeinseitig.pdf')
...
plt.plot(xwerte, f(xwerte, *params), 'b-', label='fit')
plt.legend()
plt.xlabel('$(3L^2x-4x^2)$/mm')
plt.ylabel('$D(x)$/mm')
plt.savefig('quadratischzweiseitig.pdf')
