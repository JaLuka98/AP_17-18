...
$20{,}68\%$ zum Theoriewert.
Die $K_\beta$-Linie wird bei ungefähr $20°$, die $K_\alpha$-Linie bei circa $44.6°$ identifiziert.
Die theoretisch zu erwartenden Werte für die Energien werden \cite{xraydata} entnommen und
betragen
\begin{align*}
  E_{\alpha,\text{theo}} &= 8,10 \symup{keV} \text{\cite{sample3}} \\
  E_{\beta,\text{theo}} &= \SI{8.9069}{\kilo\electronvolt} \text{\cite{sample2}}
\end{align*}
 Der theorische Wert der
Übergangsenergie liegt bei $\SI{8.9069}{\kilo\electronvolt}$ und
wird als nicht fehlerbehaftet angenommen.
Aus dem experimentellen Wert ergibt sich aus Gleichung \eqref{eqn:winkel} und dem Zusammenhang
$\lambda = hc/E$ der zu erwartende Winkel zu ungefähr $20{,}22°$. Die relative Abweichung
des experimentell bestimmten Wertes zu diesem beträgt somit $1{,}09$.
