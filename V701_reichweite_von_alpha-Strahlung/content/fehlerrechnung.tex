...
\begin{equation}
  \sigma_{\overline{x}} = \sqrt{\frac{1}{N(N-1)}
    \sum\limits_{i = 1}^N
    (x_i-\overline{x})^2}
    \label{eqn:std}
\end{equation}
Die empirische Varianz ist gegeben durch
\begin{equation}
  s = \frac{1}{N-1}
    \sum\limits_{i = 1}^N
    (x_i-\overline{x})^2
...
Diese Formel wird als \enquote{Gauß'sches Fehlerfortpflanzungsgesetz} bezeichnet.
