...
\begin{equation}
  \sigma_{E} = \sqrt{\sum\limits_{i = 1}^N\left( \frac{\partial E}{\partial x_{\symup{i}}}
   ...
   \sqrt{\frac{\frac{2}{3}\left(\frac{10}{31}\right)^{2/3}\sigma_{\symup{a}}^{2}}{R_{\symup{m}}^{1/3}}}\,.
\end{equation}
...
gemessen wird 4\,MeV. Damit ergibt sich die Energie der Strahlung für den jeweiligen
...
Dieses ist in Abbildung \ref{fig:hist} zu sehen.
