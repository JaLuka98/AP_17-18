...
print('D/U_d1 =', params[0], '+-', errors[0])
...
errors = np.sqrt(np.diag(covariance_matrix))
print('D/U_d2 =', params[0], '+-', errors[0])
...
errors = np.sqrt(np.diag(covariance_matrix))
print('D/U_d3 =', params[0], '+-', errors[0])
...
errors = np.sqrt(np.diag(covariance_matrix))
print('D/U_d4 =', params[0], '+-', errors[0])
...
errors = np.sqrt(np.diag(covariance_matrix))
print('D/U_d5 =', params[0], '+-', errors[0])
...
plt.plot(1/U_b, E, 'rx', mew=0.5, label='Messwerte')
plt.plot(1/U_b, linearfit(1/U_b, *params), 'b-', linewidth=0.5, label='Ausgleichsfunktion')

plt.xlabel(r'$\frac{1}{U_B}$')
plt.ylabel(r'$E$')
plt.tight_layout()
plt.legend()
plt.grid()
...
plt.plot(B_1, r, 'bx', mew=0.5, label='Messwerte')
plt.plot(B_1, linearfit(B_1, *params), 'b-', linewidth=0.5, label='Ausgleichsfunktion')
