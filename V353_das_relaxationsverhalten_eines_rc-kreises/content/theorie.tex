...
Durch einige weitere Überlegungen lässt sich
\begin{equation}
  A(\omega)=-\frac{\sin(\phi)}{\omega R C}U_{\text{0}}
  \label{eqn:amplitude}
\end{equation}
herleiten. Hieraus ergibt sich dann durch weitere Umformung für die Amplitude in
