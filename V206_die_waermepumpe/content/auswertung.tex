...
\begin{figure}
  ...
  \caption{Darstellung der gemessenen Temperatur im kälteren Reservoire
   und Graph der Ausgleichsfunktion}
  \label{fig:temp2}
\end{figure}

Die Parameter $A$, $B$ und $C$ ergeben sich für das wärmere Reservoire zu:
\begin{align*}
...
Für das kältere Wärmereservoire lauten die Parameter
\begin{align*}
