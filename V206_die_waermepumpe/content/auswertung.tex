...
und $T(t)$ sind als $p_\text{warm}(t)$ und $T_\text{warm}(t)$ in Tabelle \ref{tab:nmechdata} zu finden.
...
Dadurch lässt sich die Gleichung
\label{eqn:Nmech} zur Berechnung der momentanen Kompressorleistung zu den
gegebenen Zeitpunkten verwenden. In der vierten Spalte von Tabelle 6 ist der Wirkungsgrad nach
Gleichung \eqref{eqn:eta} eingetragen.
