...
\bottomrule
\end{tabular}
\caption{Parameter der Ausgleichsfunktionen}
...
\begin{equation}
  I_3 (x) = 4 \cos^2\biggl(\frac{\pi d_\text{exp} \sin(\frac{x-x_{0,3}}{L}}{\lambda}\biggr) A_{0,3} \,\, b_{\text{exp},3} \,\, \symup{sinc}^2\biggl(\frac{\pi b \sin(\frac{x-x_{0,3}}{L}}{\lambda}\biggr)
\end{equation}
...
die experimentell bestimmten Spaltbreiten der baugleichen Spalte $b_{\text{exp},3}$,
