...
Die einzeln ermittelten brechenden Winkel lassen sich mitteln, um als Ergebnis %Fehlerformel?!
\begin{equation*}
...
%Die Größen $n_\text{C}$, $n_\text{D}$ und $n_\text{F}$ bezeichnen die Brechungsindizes
