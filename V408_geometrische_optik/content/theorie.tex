...
Die geometrische Optik beschreibt einen Grenzfall der Wellenoptik, bei dem die Beugung des Lichtes
aufgrund der im Vergleich zu den Abmessungen des Versuchs sehr geringen Wellenlänge
des Lichtes zu vernachlässigen ist.  (???)
...
Zerstreuungslinsen hingegen besitzen eine negative Brenn- und Bildweite. In ihnen entsteht ein
...
Mittelebene bzw. den Hauptebenen nur für achsennah einfallende Strahlen gilt. Ansonsten
ergeben sich Ungenauigkeiten, die man auch sphärische Abberation nennt.
...
und $b$ und $g$ die jeweils entsprechende Weite.
