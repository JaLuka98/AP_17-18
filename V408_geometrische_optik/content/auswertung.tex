...
Die Messwerte sind in \ref{tab:unbekannt} zu finden.
...
Brennweite für die Wasserlinse.

HIER NOCH LINSENGlEICHUNG UND RECHNERISCH
...
führt. Unter Beachtung der Gleichungen \eqref{eqn:mean} und \eqref{eqn:std} lässt sich
dann die Brennweite der Linse unter weißem Licht zu $\SI{144.1(8)}{\milli\meter}$ bestimmen.
...
\begin{align*}
	f_g &= \SI{4.32(15)}{\centi\meter}		&		h &= {0.8(8)}{\centi\meter}\,,\ \\
	f_b &= \SI{4.6(4)}{\centi\meter}		&		h^\prime &= {5.1}(5){\centi\meter}\,,
\end{align*}
